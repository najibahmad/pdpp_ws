...
<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
				<h2 class="page-header top15">Ganti Password Pengguna : <strong>{{ $pengguna->nama_pengguna}}</strong</h2>
		</div>
		<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="panel panel-default">
						...
						<div class="panel-body">
								<div class="row">
									<div class="col-lg-12">
										<form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/changepassworduser/'.$pengguna->id_pengguna) }}">
	                      {{ csrf_field() }}
