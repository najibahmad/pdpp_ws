...
<!-- 						<div class="panel-heading">
 ...
 -->						<!-- /.panel-heading -->
              ...
              <div class="row bottom10">
                <p>
                  <a class="btn btn-primary left15" href="{{ url('/admin/exsportpotensiekonomipdf/') }}"><i class="fa fa-file-pdf-o"></i>  Export PDF</a>
                  <a class="btn btn-primary left15" href="{{ url('/admin/exsportpotensiekonomixls/') }}"><i class="fa fa-file-excel-o"></i>  Export Excel </a>
                </p>
              </div>
