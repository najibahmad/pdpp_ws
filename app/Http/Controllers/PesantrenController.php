...
class PesantrenController extends Controller
{
    ...
    public function edit($id)
    {
      ...
      return view('pesantren.edit',compact('tenaga_pengajar','santri','kabupaten',
              'pesantren','tipe_pesantren','potensi_ekonomi','konsentrasi'));
    }
    ...
    public function update(PesantrenRequest $request, $id)
    {
      ...
      \Session::flash('pesan','Pesantren telah berhasil diperbaharui!');
